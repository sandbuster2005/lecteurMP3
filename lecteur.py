...
class App:
    ...
    from libs.handmade._interface import select_img,edit_command,mani_file,check_adress,change_main_path,change_sound_manager,display,yt_search,dl_yt_playlist       
